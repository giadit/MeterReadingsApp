...
import com.example.mypostsapp.data.Location // Import new Location data class
import com.example.mypostsapp.databinding.ItemLocationBinding // Will rename/update this layout
